...
CXX11_CONSTEXPR inline T _sj_shl_int(T const &x, TM const &shift) CXX11_NOEXCEPT_IF(noexcept(x << shift))
    ...
    CXX20_REQUIRES(std::integral<T> &&std::integral<TM>)
{
    ...
    int shift_limit = sizeof(T) * 8 - 1;
    casted_x = y > shift_limit ? 0 : (casted_x >> y);
    return static_cast<T>(casted_x);
}
...
{
    int shift_limit = sizeof(T) * 8 - 1;
    return y > shift_limit ? x >> shift_limit : x >> y;
}

template <typename T>
CXX11_CONSTEXPR inline _sj_sequential_vtuple2<T, uint8_t> _sj_checked_sadd_int(T const &x, T const &y) CXX11_NOEXCEPT
{
#if defined(USE_BUILTIN_CHECKED_ARITHMETIC) && defined(__SIZEOF_INT128__)
    T res;
...
template <typename T>
CXX11_CONSTEXPR inline _sj_sequential_vtuple2<T, uint8_t> _sj_checked_uadd_int(T const &x, T const &y) CXX11_NOEXCEPT
{
#if defined(USE_BUILTIN_CHECKED_ARITHMETIC) && defined(__SIZEOF_INT128__)
    T res;
    uint8_t overflown = __builtin_add_overflow(x, y, &res) ? 1 : 0;
...
template <typename T>
CXX11_CONSTEXPR inline _sj_sequential_vtuple2<T, uint8_t> _sj_checked_ssub_int(T const &x, T const &y) CXX11_NOEXCEPT
{
#if defined(USE_BUILTIN_CHECKED_ARITHMETIC) && defined(__SIZEOF_INT128__)
    T res;
...
template <typename T>
CXX11_CONSTEXPR inline _sj_sequential_vtuple2<T, uint8_t> _sj_checked_usub_int(T const &x, T const &y) CXX11_NOEXCEPT
{
#if defined(USE_BUILTIN_CHECKED_ARITHMETIC) && defined(__SIZEOF_INT128__)
    T res;
    uint8_t overflown = __builtin_sub_overflow(x, y, &res) ? 1 : 0;
...
template <typename T>
CXX11_CONSTEXPR inline _sj_sequential_vtuple2<T, uint8_t> _sj_checked_smul_int(T const &x, T const &y) CXX11_NOEXCEPT
{
#if defined(USE_BUILTIN_CHECKED_ARITHMETIC) && defined(__SIZEOF_INT128__)
    T res;
...
template <typename T>
CXX11_CONSTEXPR inline _sj_sequential_vtuple2<T, uint8_t> _sj_checked_umul_int(T const &x, T const &y) CXX11_NOEXCEPT
{
#if defined(USE_BUILTIN_CHECKED_ARITHMETIC) && defined(__SIZEOF_INT128__)
    T res;
